...
class FSERIES extends CI_Controller 
{
	...
	public function F_series(){
		// echo base_url();
		// //echo 'docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/index.html';
		// exit();
		$this->load->view('docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/index.html');
	}

	public function F_series_menu(){
		$this->load->view('docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/menu.html');
	...
	public function frame_html(){
		...
		$this->load->view('docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/frame.html');
	}
	...
	public function manual_docs(){
		...
		if ($svg===false){
			if ($pos===false){
				$this->load->view('docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/si/'.$urlname.'.html');
			}else{
				$this->load->view('docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/si/'.$urlname);
			}
		}else
		{
			$this->svgViewer();
	...
	public function svgViewer(){
		...
		//
		redirect(base_url().'docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/si/svg_viewer/svg_viewer.html?type=open'.$concat); 

	}

	
	public function notfound(){
		$this->load->view('docs/VESI/Fseries/MGHTML-WEN-1771IG_20171102/notfound.html');
	}

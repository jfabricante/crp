...
class TSERIES extends CI_Controller 
{
	...
	public function T_series(){
		// echo base_url();
		// //echo 'docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/index.html';
		// exit();
		$this->load->view('docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/index.html');
	}

	public function T_series_menu(){
		$this->load->view('docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/menu.html');
	...
	public function frame_html(){
		...
		$this->load->view('docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/frame.html');
	}
	...
	public function manual_docs(){
		...
		if ($svg===false){
			if ($pos===false){
				$this->load->view('docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/si/'.$urlname.'.html');
			}else{
				$this->load->view('docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/si/'.$urlname);
			}
		}else
		{
			$this->svgViewer();
	...
	public function svgViewer(){
		...
		//
		redirect(base_url().'docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/si/svg_viewer/svg_viewer.html?type=open'.$concat); 

	}

	
	public function notfound(){
		$this->load->view('docs/VESI/TFSeries/TFHTML-WEN-1761_20170630/notfound.html');
	}

...
class VESI extends CI_Controller 
{
	...
	public function c_series(){
		...
		// exit();
		$this->load->view('docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/index.html');
	}

	public function c_series_menu(){
		$this->load->view('docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/menu.html');
	...
	public function frame_html(){
		...
		$this->load->view('docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/frame.html');
	}
	...
	public function manual_docs(){
		...
		if ($svg===false){
			if ($pos===false){
				$this->load->view('docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/si/'.$urlname.'.html');
			}else{
				$this->load->view('docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/si/'.$urlname);
			}
		}else
		{
			$this->svgViewer();
	...
	public function svgViewer(){
		...
		//
		redirect(base_url().'docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/si/svg_viewer/svg_viewer.html?type=open'.$concat); 

	}

	
	public function notfound(){
		$this->load->view('docs/VESI/CESeries/HGHTML-WEN-1331E5_20180122/notfound.html');
	}

<!-- Items block -->
<section class="content branches">
	<!-- row -->
	<div class="row">
		<!-- col-md-6 -->
		<div class="col-md-5">
			...
			<div class="box box-danger">
				...
				<div class="box-header with-border">
					<a href="<?php echo base_url('index.php/branch/form') ?>" data-toggle="modal" data-target=".bs-example-modal-sm">
						<button class="btn btn-flat btn-success pull-right">Add Branch <i class="fa fw fa-plus" aria-hidden="true"></i></button>
					</a>
				</div>
